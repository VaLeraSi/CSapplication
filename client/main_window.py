...
sys.path.append('../')
from CSapplication.client.main_window_conv import Ui_MainClientWindow
from CSapplication.client.add_contact import AddContactDialog
from CSapplication.client.del_contact import DelContactDialog
from CSapplication.client.database import ClientDatabase
from CSapplication.client.transport import ClientTransport
from CSapplication.client.start_dialog import UserNameDialog
from CSapplication.common.errors import ServerError
