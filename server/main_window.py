...
from CSapplication.server.stat_window import StatWindow
from CSapplication.server.config_window import ConfigWindow
from CSapplication.server.add_user import RegisterUser
from CSapplication.server.remove_user import DelUserDialog
